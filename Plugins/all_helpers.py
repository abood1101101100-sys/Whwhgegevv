    ...
    try:
        ...
        if resp.result.is_nsfw:
            ...
            await m.reply(
                ...
                f"{k} تم حذف رسالتك لإحتوائها على محتوى إباحي .\n☆"
            )
    finally:
        os.remove(file)
        await session.close()
...
async def guardResponseFunction2(c, m, k: str, channel: str) -> None:
    ...
    if (
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            return await m.reply(
                warner.format(mention, k, "التعديل"), disable_web_page_preview=True
            )
    ...
    if (
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "تعديل الميديا"), disable_web_page_preview=True
            )
...
async def guardResponseFunction(c, m, k: str, channel: str) -> None:
        ...
        for me in m.new_chat_members:
            if not me.id == m.from_user.id:
                ...
                if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}"):
                    return await m.reply(
                        warner.format(mention, k, "تضيف حد هنا"),
    ...
    if await rdb.get(f"{m.chat.id}:lockInline:{Dev_Zaid}") and m.via_bot:
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل انلاين"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(f"{m.chat.id}:lockForward:{Dev_Zaid}") and m.forward_date:
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل توجيه"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(f"{m.chat.id}:lockAudios:{Dev_Zaid}") and m.audio:
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل صوت"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(f"{m.chat.id}:lockVideo:{Dev_Zaid}") and m.video:
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل فيديوهات"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(f"{m.chat.id}:lockPhoto:{Dev_Zaid}") and m.photo:
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل صور"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(f"{m.chat.id}:lockStickers:{Dev_Zaid}") and m.sticker:
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل ملصقات"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(f"{m.chat.id}:lockAnimations:{Dev_Zaid}") and m.animation:
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل متحركات"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(f"{m.chat.id}:lockFiles:{Dev_Zaid}") and m.document:
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل ملفات"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(f"{m.chat.id}:lockPersian:{Dev_Zaid}") and m.text:
        if "ه‍" in m.text or "ی" in m.text or "ک" in m.text or "چ" in m.text:
            ...
            if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}"):
                return await m.reply(
                    warner.format(mention, k, "ترسل فارسي"), disable_web_page_preview=True
                )
    ...
    if (
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل روابط"), disable_web_page_preview=True
            )
    ...
    if (
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل هاشتاق"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(f"{m.chat.id}:lockMessages:{Dev_Zaid}") and m.text and len(m.text) > 150:
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل كلام كثير"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(f"{m.chat.id}:lockVoice:{Dev_Zaid}") and m.voice:
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل فويس"), disable_web_page_preview=True
            )
    ...
    if await rdb.get(
        ...
        if not await rdb.get(f"{m.chat.id}:disableWarn:{Dev_Zaid}") and not await rdb.get(
            ...
            await rdb.set(f"{Dev_Zaid}:inWARN:{m.from_user.id}{m.chat.id}", 1, ex=60)
            return await m.reply(
                warner.format(mention, k, "ترسل منشنات"), disable_web_page_preview=True
            )
