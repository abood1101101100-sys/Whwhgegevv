"""
helpers/memes.py — bmqa-v2

منقول من bmqa/helpers/memes.py بدون أي تعديل: الملف لا يحتوي أي دالة ولا
أي استيراد (لا requests ولا time.sleep ولا غيرها) — فقط قوائم بيانات ثابتة
(list of dict) لأسماء الميمز وروابط الصوتيات المحلية (myinstants.com)،
لذلك لا يوجد أي استدعاء شبكي ولا كود sync يُحوَّل إلى async هنا.
"""
