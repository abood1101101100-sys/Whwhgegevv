"""
helpers/quran.py — bmqa-v2

مُنقول من bmqa/helpers/quran.py بدون أي تعديل: الملف لا يحتوي أي دالة ولا
أي استيراد (لا requests ولا غيرها) — فقط بنيتا بيانات ثابتتان (list وdict)،
لذلك لا يوجد ما يُحوَّل من sync إلى async هنا.
"""
