"""
helpers/persianData.py — bmqa-v2

منقول من bmqa/helpers/persianData.py بدون أي تعديل: الملف لا يحتوي أي دالة
ولا أي استيراد (لا requests ولا redis/kvsqlite ولا time.sleep ولا غيرها) —
فقط قاموس بيانات ثابت واحد (persianInformation) يحتوي نصوصاً وبيانات فارسية،
لذلك لا يوجد أي كود sync يُحوَّل إلى async هنا.
"""
